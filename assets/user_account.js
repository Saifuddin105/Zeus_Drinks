...
const email_edit_btn = document.querySelector(".edit_button");
const email_cancel_btn = document.querySelector(".cancel_Btn");
...
const pass_edit_btn = document.querySelector(".edit_button_pass");
const pass_cancel_btn = document.querySelector(".cancel_Btn_2");
...
const PH_button = document.querySelector(".PH_btn");
const MD_btn = document.querySelector(".MD_btn");
